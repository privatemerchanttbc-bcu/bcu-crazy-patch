...
public final class Logger {
    ...
    static {
        try {
            ...
            System.err.println("[ManualControl] Cannot open log file: " + e);
        }
    }
    ...
    private static File resolveLogFile() {
        String configured = System.getProperty("manualcontrol.log");
        File file = configured != null && configured.trim().length() > 0
                ? new File(configured)
                : new File("manual-control.log");
    ...
    public static synchronized void log(String msg) {
        ...
        System.out.println("[ManualControl] " + msg);
        if (writer != null) {
            writer.println(line);
            writer.flush();
        }
    ...
    public static synchronized void err(String msg, Throwable t) {
        ...
        System.err.println("[ManualControl] ERROR: " + msg);
        if (writer != null) {
            writer.println(line);
